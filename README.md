...
7. **Summer coast (v2-avvikelse).** Inspirerad av Comfortzones inbyggda sommarfunktion, men med rikare data: när dagens högsta är ≥ 18°C, morgondagens högsta ≥ 13°C, utomhus just nu ≥ 12°C, inomhus ≥ default-0.5°C, och det inte är vinter → triggar Weather Anticipation Reduction oavsett tid eller pris. Bygnaden coast:ar på sol- och luftvärme istället för att betala för värme som ändå överskjuts av eftermiddagssolen. **VV-logiken är oförändrad** — endast climate-grenen påverkas av denna gate.
